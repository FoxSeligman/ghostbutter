...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("graphics/bricks.png", __ASSET__graphics_bricks_png);
		type.set ("graphics/bricks.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("graphics/ghostbody.png", __ASSET__graphics_ghostbody_png);
		type.set ("graphics/ghostbody.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("graphics/ghosttailparticle.png", __ASSET__graphics_ghosttailparticle_png);
		type.set ("graphics/ghosttailparticle.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("font/04B_03__.ttf", __ASSET__font_5);
		type.set ("font/04B_03__.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		className.set ("maps/jode.tmx", __ASSET__maps_jode_tmx);
		type.set ("maps/jode.tmx", Reflect.field (AssetType, "binary".toUpperCase ()));
		className.set ("maps/vic.tmx", __ASSET__maps_vic_tmx);
		type.set ("maps/vic.tmx", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		className.set ("font/04B_03__.ttf", __ASSET__font_04b_03___ttf);
		type.set ("font/04B_03__.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		path.set ("graphics/bricks.png", "graphics/bricks.png");
		type.set ("graphics/bricks.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("graphics/ghostbody.png", "graphics/ghostbody.png");
		type.set ("graphics/ghostbody.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("graphics/ghosttailparticle.png", "graphics/ghosttailparticle.png");
		type.set ("graphics/ghosttailparticle.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("font/04B_03__.ttf", __ASSET__font_5);
		type.set ("font/04B_03__.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		path.set ("maps/jode.tmx", "maps/jode.tmx");
		type.set ("maps/jode.tmx", Reflect.field (AssetType, "binary".toUpperCase ()));
		path.set ("maps/vic.tmx", "maps/vic.tmx");
		type.set ("maps/vic.tmx", Reflect.field (AssetType, "binary".toUpperCase ()));
...
class __ASSET__graphics_bricks_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__graphics_ghostbody_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__graphics_ghosttailparticle_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__font_5 extends null { }
class __ASSET__maps_jode_tmx extends null { }
class __ASSET__maps_vic_tmx extends null { }
